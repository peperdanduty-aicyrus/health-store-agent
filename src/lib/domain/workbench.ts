...
export const workbenchToolDefinitions: Record<WorkbenchGenerationType, { label: string; description: string }> = {
  mealbox_video: {
    label: "小饭盒视频助手",
    description: "生成医院食堂小饭盒切入的本地门店检查短视频脚本。",
  },
  promotion_copy: {
    label: "推广文案助手",
...
export const workbenchFieldDefinitions: Record<WorkbenchGenerationType, WorkbenchFieldDefinition[]> = {
  mealbox_video: [
    { label: "今日饭菜描述", name: "mealDescription", placeholder: "例如医院食堂一荤一素", type: "input" },
    {
      label: "店铺行业",
      name: "storeType",
    ...
    { label: "检查平台", name: "targetPlatform", options: ["美团", "大众点评", "抖音", "小红书", "闲鱼", "朋友圈", "其他"], type: "select" },
    {
      label: "店铺主要问题",
      name: "storeIssue",
    ...
    { label: "视频发布平台", name: "publishPlatform", options: ["抖音", "视频号", "小红书", "朋友圈", "多平台同步"], type: "select" },
    { label: "内容风格", name: "contentStyle", options: ["真实接地气", "轻松吐槽", "专业顾问", "老板能听懂", "医院打工人午休副业风"], type: "select" },
  ...
  promotion_copy: [
    {
      label: "推广产品",
      name: "product",
      options: ["4.9 元基础体检", "69 元全面体检 + 修改方案", "39 元 AI 网站工具月卡", "AI 网站工具免费三天试用", "美团点评代运营", "小红书本地运营陪跑", "抖音本地生活陪跑", "闲鱼获客陪跑", "朋友圈私域成交陪跑"],
      type: "select",
    },
    {
      label: "目标客户",
    ...
    { label: "发布平台", name: "publishPlatform", options: ["抖音", "视频号", "小红书", "闲鱼", "朋友圈", "微信群", "微信私聊", "多平台同步"], type: "select" },
    { label: "补充信息", name: "extraInfo", placeholder: "例如要强调免费三天试用、先做基础体检", required: false, type: "textarea" },
  ],
  poster_prompt: [
    { label: "海报类别", name: "posterCategory", options: ["小饭盒系列店铺检查", "儿童教培宣传", "网站/代运营推广"], type: "select" },
    { label: "使用场景", name: "usageScene", options: ["抖音封面", "视频号封面", "小红书封面", "闲鱼主图", "朋友圈海报", "微信群宣传图"], type: "select" },
    {
      label: "目标客户",
      name: "targetCustomer",
    ...
    { label: "核心痛点", name: "corePain", placeholder: "例如没人咨询、课程招生难、页面乱", type: "input" },
    { label: "主推内容", name: "mainContent", placeholder: "例如 4.9 元基础体检、儿童托管招生", type: "input" },
    { label: "设计风格", name: "designStyle", options: ["真实接地气", "醒目大字", "绿色底图", "白底黑字", "强对比", "专业顾问风", "生活化风", "儿童活泼风", "本地门店风"], type: "select" },
  ...
  moments_library: [
    ...
    { label: "目标客户", name: "targetCustomer", options: ["中医馆老板", "推拿馆老板", "口腔门诊", "健康管理中心", "宠物医院", "儿童教培机构", "本地生活门店老板", "个体商家", "其他"], type: "select" },
    { label: "文案风格", name: "copyStyle", options: ["真实接地气", "朋友圈日常分享", "轻微成交感", "专业顾问感", "老板能看懂", "不硬广", "带一点危机感", "案例拆解风"], type: "select" },
    { label: "发布目的", name: "publishGoal", options: ["引导咨询", "引导做 4.9 基础体检", "引导做 69 全面体检", "引导试用 AI 网站工具", "引导代运营合作", "引导私聊", "朋友圈长期种草"], type: "select" },
